...
import { projectDtoStub, MemberProjectResDto, MemberProjectsResDto, MemberResDto, ProjectResDto, DeviceResDto, ProjectReleasesDto } from '@app/common/dto/project-management';
...
describe('ProjectManagementService', () => {
  ...
  describe('createProject', () => {
    it('should create a new project', async () => {
      ...
      const projectResDto = new ProjectResDto().fromProjectEntity(createdMemberProjectEntity.project);
  ...
  describe('getUserProjects', () => {
    it('should return user projects and member details', async () => {
      ...
      const expectedProjectDto = new ProjectResDto();
